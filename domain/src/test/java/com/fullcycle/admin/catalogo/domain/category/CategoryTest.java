...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReciveError(){
        final String expectedName = """
                   Todavia, a constante divulgação das informações acarreta um processo de reformulação e modernização do orçamento setorial. Por outro lado, o consenso sobre a necessidade de qualificação não pode mais se dissociar das posturas dos órgãos dirigentes com relação às suas atribuições. Assim mesmo, a crescente influência da mídia apresenta tendências no sentido de aprovar a manutenção do sistema de participação geral. No mundo atual, a contínua expansão de nossa atividade auxilia a preparação e a composição das diversas correntes de pensamento. O incentivo ao avanço tecnológico, assim como a consulta aos diversos militantes assume importantes posições no estabelecimento dos conhecimentos estratégicos para atingir a excelência.
                """;
    ...
    @Test
    public void givenAValidActiveCategory_whenCallDesactivate_thenReturnCategoryInactivated(){
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = false;
